...
- Calculating of the normalizing constant in \eqref{eq:ergm} makes ERGMs difficult to estimate.
...
- We have implemented  this and more in the `ergmito` R package (\url{https://github.com/muriteams/ergmito})
