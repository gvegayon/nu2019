...
- Includes a simulation function for efficiently drawing samples of small networks, and by **effiently** we mean **fast**. 
...
```{r preleminary-results, echo=FALSE, results='asis', warning=FALSE, message=FALSE, cache=TRUE}
