...
- Imagine that $\depvar_\graph = \mbox{\texttt{nodeicov("female")}}_\graph + \varepsilon$, $\varepsilon\sim N(0,1)$

- Our test statistic $t$ is the correlation between $\depvar$ and \texttt{nodeicov("female")}
